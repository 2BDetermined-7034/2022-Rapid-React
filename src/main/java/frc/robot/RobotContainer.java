...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    private void configureButtonBindings() {
        ...
        joystick2.getButton(2).toggleWhenPressed(m_toggleClimbSolenoid);
        ...
        m_GPad.getButton("BACK").toggleWhenPressed(m_intakeSolToggle);
        // Indexer
        ...
        // Climb
        m_climbPad.getButton("A").toggleWhenPressed(m_toggleClimbSolenoid);
